...
{else}
	...
	<section class="footer-block col-xs-12 col-sm-3" id="block_various_links_footer">
		...
		<ul class="bullet">
			...
			{/if}
			<li>
				<a href="{smartblog::GetSmartBlogLink('smartblog')}" title="Blog">
					Blog
				</a>
			</li>
		</ul>
	...
	<section class="bottom-footer col-xs-12">
		<div>
			&copy; {date ("Y")} {$shop_name|escape:'html':'UTF-8'}<br /><span>Theme <a href="http://www.webempresa.com/hosting-prestashop.html" target="_blank" >PrestaShop by webempresa</a></span>
		</div>
	</section>
	{/if}
	<!-- /MODULE Block footer -->
