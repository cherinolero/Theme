...
<div class="col-sm-12 clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if}">
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			...
			<span class="cart-ico">{l s='Cart' mod='blockcart'}: </span>
			...
			<span class="ajax_cart_product_txt_s{if $cart_qties == 1} unvisible{/if}">{l s='Products' mod='blockcart'})</span>
