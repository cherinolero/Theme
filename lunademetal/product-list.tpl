...
{if isset($products) && $products}
	...
	{foreach from=$products item=product name=products}
				...
				<div class="left-block">
					<div class="product-image-container">
						...
						{if isset($quick_view) && $quick_view}
							...
							<a itemprop="url" class="info-view" href="{$product.link|escape:'html':'UTF-8'}" title="{l s='View'}">
		...
		{if $page_name =='index'}
			{if $smarty.foreach.products.iteration%$nbItemsPerLine ==0 && 1==2}  
				<li class="borde-producto {if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModulo)} last-line{/if}"></li>
			{/if}
		{/if}
